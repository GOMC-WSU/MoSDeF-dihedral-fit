...
.. raw:: html
  ...
  <div class="admonition note">
      <p>This page was generated from
        <a class="reference external" href="https://github.com/GOMC-WSU/MoSDeF-dihedral-fit/blob/{{ env.config.release|e }}/{{ docname|e }}">{{ docname|e }}</a>.
        <br>Interactive online version:
        <a href="https://mybinder.org/v2/gh/GOMC-WSU/MoSDeF-dihedral-fit/master?filepath={{ docname|e }}"><img alt="Binder badge" src="https://mybinder.org/badge_logo.svg" style="vertical-align:text-bottom"></a>.
      </p>
    </div>
...
project = "MoSDeF-dihedral-fit"
author = (
    "Crawford, Brad  and Quach, Co "
    "and Craven, Nicholas and Iacovella, Christopher R. "
